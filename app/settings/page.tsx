    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2 border-b border-[#C6C6C8]">
          <button onClick={onClose} className="text-[17px] font-normal text-[#007AFF]">
            Done
          </button>
            ...
            {options.map((option, index) => (
              <button
                ...
                className={`w-full h-[44px] flex items-center justify-center text-[21px] transition-all ${
                  selectedValue === option ? "font-semibold text-[#424242]" : "font-normal text-[#757575]"
                }`}
              >
                {option}
              </button>
  ...
  return (
    ...
    >
        ...
        <div className="max-w-[350px] mx-auto w-full flex flex-col gap-6 flex-1">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2.5">
              <div className="px-4">
                <h2
                  className="text-[15px] font-bold leading-[19px] text-[#757575]"
                  style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                >
                  Temp shifts
                </h2>
              ...
              <div className="flex flex-col gap-px">
                ...
                >
                  <div className="flex-1 flex flex-col justify-center gap-1">
                    <span
                      className="text-[15px] font-semibold leading-[19px] text-[#424242] text-left"
                      style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                    >
                      Minimum shift
                    </span>
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className="text-[15px] font-medium leading-[19px] text-[#424242]"
                      style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                    >
                      {minimumShift}
                    </span>
                ...
                <div className="flex items-center gap-4 px-4 py-4 bg-white h-[62px]">
                  <div className="flex-1 flex flex-col gap-1">
                    <span
                      className="text-[15px] font-semibold leading-[19px] text-[#424242]"
                      style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                    >
                      Show rising shifts
                    </span>
                  ...
                  >
                    <div
                      className={`w-[30px] h-[30px] bg-white rounded-full border-[1.6px] transition-all duration-[450ms] ${
                ...
                <div className="flex items-center gap-4 px-4 py-4 bg-white h-[112px]">
                  <div className="flex-1 flex flex-col gap-1">
                    <span
                      ...
                      style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                    >
                      Include night temperatures
                    </span>
                    <span
                      className="text-[15px] font-normal leading-[19px] tracking-tight text-[#9E9E9E]"
                      style={{ WebkitFontSmoothing: "antialiased", MozOsxFontSmoothing: "grayscale" }}
                    >
      ...
      <div className="flex items-center justify-center py-6">
        <span className="text-[13px] font-normal leading-5 text-[#9E9E9E]" style={{ letterSpacing: "0.01em" }}>
          sunario© 2025
        </span>
      </div>
    </div>
